...
function fromGeminiCandidate(candidate) {
  ...
  return {
    ...
    message: {
      role: "model",
      content: (((_a = candidate.content) == null ? void 0 : _a.parts) || []).map(fromGeminiPart)
    },
...
function googleAIModel(name, apiKey, apiVersion, baseUrl) {
  ...
  if ((_b = (_a = model == null ? void 0 : model.info) == null ? void 0 : _a.supports) == null ? void 0 : _b.media) {
    middleware.push((0, import_middleware.downloadRequestMedia)({ maxBytes: 1024 * 1024 * 10 }));
  }
  return (0, import_model.defineModel)(
    ...
    (request, streamingCallback) => __async(this, null, function* () {
      ...
      if (streamingCallback) {
        ...
        if (!((_m = result.response.candidates) == null ? void 0 : _m.length))
          throw new Error("No valid candidates returned.");
        const responseCandidates = ((_n = result.response.candidates) == null ? void 0 : _n.map(fromGeminiCandidate)) || [];
        return {
          candidates: responseCandidates,
          custom: result.response,
          usage: (0, import_model.getBasicUsageStats)(request.messages, responseCandidates)
        };
      }
    })
  );
